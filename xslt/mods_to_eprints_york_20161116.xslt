...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:template match="v3:mods">
		<eprints>
			<eprint>
				...
				<xsl:choose>
					<xsl:when
						test="v3:note[@type='researchoutput workflow state' and text()='approved']">
				...
				<xsl:if
					test="v3:name[@type='personal']/v3:role/v3:roleTerm[@authority='pure/email']">
					<contact_email>
						<xsl:value-of
							select="v3:name[@type='personal']/v3:role/v3:roleTerm[@authority='pure/email']"
						/>
					</contact_email>
				</xsl:if>
				...
				<!-- Authors -->
				<xsl:if
					test="v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role'] != 'editor' and v3:namePart[@type = 'family']]">
					<creators>
						<xsl:for-each
							select="v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role'] != 'editor' and v3:namePart[@type = 'family']]">
							<item>
								<xsl:choose>
									<xsl:when test="v3:role/v3:roleTerm[@authority='pure/orcid']">
										<id>
											<xsl:value-of
												select="v3:role/v3:roleTerm[@authority='pure/orcid']"
											/>
										</id>
									</xsl:when>
									<xsl:otherwise>
										<id>
											<xsl:value-of
												select="v3:role/v3:roleTerm[@authority='pure/email']"
											/>
										</id>
									</xsl:otherwise>
								</xsl:choose>
				...
				<!-- Group Authors -->
				<xsl:for-each
					select="v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role'] != 'editor' and not(v3:namePart[@type = 'family'])]">
					<corp_creators>
						<xsl:value-of select="v3:namePart[@type='given']"/>
					</corp_creators>
				</xsl:for-each>
				...
				<!-- Editors -->
				<xsl:if
					test="v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role'] = 'editor']">
					<editors>
						<xsl:for-each
							select="v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role'] = 'editor']">
							<item>
								<xsl:choose>
									<xsl:when test="v3:role/v3:roleTerm[@authority='pure/orcid']">
										<id>
				...
				<xsl:if
					test="v3:name[@type='corporate']/v3:role/v3:roleTerm[@authority='pure/linkidentifier/eprint']">
					<iau_pure>
						<xsl:for-each
							select="v3:name[@type='corporate']/v3:role/v3:roleTerm[@authority='pure/linkidentifier/eprint']">
							<item>
								<xsl:value-of select="."/>
							</item>
						</xsl:for-each>
				...
				<xsl:choose>
					<xsl:when
						test="v3:note[@type='peerreview status' and text()='Peer reviewed'] or v3:genre[@type='publicationType'] = '/dk/atira/pure/researchoutput/researchoutputtypes/contributiontobookanthology/peerreviewedchapter'">
	...
	<xsl:template match="v3:relatedItem[@type='host']/v3:part/v3:detail[@type='issue']/v3:number">
		<xsl:choose>
			<xsl:when
				test="starts-with(/v3:mods/v3:genre[@type='publicationType'], '/dk/atira/pure/researchoutput/researchoutputtypes/bookanthology/') or starts-with(/v3:mods/v3:genre[@type='publicationType'], '/dk/atira/pure/researchoutput/researchoutputtypes/contributiontobookanthology/')">
				<edition>
					<xsl:value-of select="."/>
				</edition>
			</xsl:when>
	...
	<xsl:template
		match="v3:relatedItem[@type='host']/v3:part/v3:detail[@type='citation']/v3:caption">
		<pagerange>
			<xsl:value-of select="."/>
		</pagerange>
	</xsl:template>
	...
	<xsl:template
		match="v3:relatedItem[@type='host']/v3:part/v3:detail[@type='articleNumber']/v3:number">
		<article_number>
			<xsl:value-of select="."/>
		</article_number>
	</xsl:template>
	...
	<xsl:template
		match="v3:relatedItem[@type='host' and @xlin:role='conference']/v3:titleInfo/v3:title">
		<event_title>
			<xsl:value-of select="."/>
		</event_title>
	</xsl:template>
	...
	<xsl:template
		match="v3:relatedItem[@type='host' and @xlin:role='conference']/v3:location/v3:physicalLocation">
		<event_location>
			<xsl:value-of select="."/>
		</event_location>
	</xsl:template>
	...
	<xsl:template match="v3:relatedItem[@type='host' and @xlin:role='conference']/v3:part">
		<xsl:choose>
			<xsl:when test="v3:date[@point='start'] and v3:date[@point='end']">
				<event_dates><xsl:value-of select="v3:date[@point='start']"/> - <xsl:value-of
						select="v3:date[@point='end']"/></event_dates>
			</xsl:when>
	...
	<xsl:template match="v3:genre[@type='publicationType']">
		...
		<xsl:choose>
			<!-- Other contribution -->
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/othercontribution/')">
				<type>other</type>
			...
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/contributiontojournal/')">
				<type>article</type>
			...
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/contributiontoperiodical/')">
				<type>article</type>
			...
			<!-- Patent -->
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/patent/')">
				<type>patent</type>
			...
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/contributiontoconference/')">
			...
			<!-- Book Anthology -->
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/bookanthology/')">
				<xsl:choose>
			...
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/contributiontobookanthology/')">
				<xsl:choose>
			...
			<!-- Non-textual -->
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/nontextual/')">
				<xsl:choose>
			...
			<!-- Working Paper -->
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/workingpaper/')">
				<type>monograph</type>
				<xsl:call-template name="monographType">
					<xsl:with-param name="uriToken" select="$typeToken"/>
				</xsl:call-template>
			...
			<!-- Thesis -->
			<xsl:when
				test="starts-with(text(), '/dk/atira/pure/researchoutput/researchoutputtypes/thesis/')">
	...
	<xsl:template name="conferenceItemType">
		...
		<xsl:choose>
			<xsl:when
				test="../v3:relatedItem[@type='host' and @xlin:role='conference']/v3:part/v3:text[@xlin:role='pure/conferencetype']='Conference'">
				<event_type>conference</event_type>
			</xsl:when>
			<xsl:when
				test="../v3:relatedItem[@type='host' and @xlin:role='conference']/v3:part/v3:text[@xlin:role='pure/conferencetype']='Workshop'">
	...
	<xsl:template name="patentType">
		<xsl:if
			test="../v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role']='inventor']">
			<patent_applicant><xsl:value-of
					select="../v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role']='inventor']/v3:namePart[@type='family']"
				/>, <xsl:value-of
					select="../v3:name[@type='personal' and v3:role/v3:roleTerm[@authority='pure/role']='inventor']/v3:namePart[@type='given']"
				/></patent_applicant>
		</xsl:if>
		<xsl:choose>
	...
	<xsl:template name="uppercase">
		<xsl:param name="uri"/>
		<xsl:value-of
			select="translate($uri, 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ')"/>
	</xsl:template>
</xsl:stylesheet>
